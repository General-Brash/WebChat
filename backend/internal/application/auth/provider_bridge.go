...
const (
	// ProviderAuthBridgeProtocolVersion identifies the OAuth handoff contract version.
	ProviderAuthBridgeProtocolVersion = 1
	// ProviderAuthWebClientID identifies the web client in provider handoff requests.
	ProviderAuthWebClientID = "deeix-web"
	// ProviderAuthNativeClientID identifies the native client in provider handoff requests.
	ProviderAuthNativeClientID = "com.deeix.chat.native"
	// ProviderAuthDesktopClientID identifies the desktop client in provider handoff requests.
...
// ProviderAuthBridgeStartInput contains the client request for an OAuth handoff.
...
// ProviderAuthBridgeCallbackInput contains the provider callback parameters.
...
// ProviderAuthBridgeCallbackResult contains the client redirect generated by the callback.
type ProviderAuthBridgeCallbackResult struct {
	RedirectURI string
}

// ProviderAuthBridgeExchangeInput contains the client request to exchange a grant.
...
// StartProviderAuthBridge starts a short-lived provider authorization transaction.
...
// CompleteProviderAuthBridgeCallback consumes a provider callback and creates a grant.
...
// ExchangeProviderAuthBridgeGrant exchanges a valid handoff grant for an application session.
